...
""" % {
 ...
 'openssl': '-I%(openssl)s/include -L%(openssl)s/lib -Wl,-rpath,%(openssl)s/lib -lcrypto -lssl' % {
 ...
 'ncurses': '-I%(ncurses)s/include/ncurses -I%(ncurses)s/include -L%(ncurses)s/lib -Wl,-rpath,%(ncurses)s/lib -lpanel -lform -lmenu -lncurses' % {
